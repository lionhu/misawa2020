<template>
        <div class=" nobottommargin">
            ...
            <el-table
                ...
                <el-table-column label="SKU" prop="product_code" sortable>
                </el-table-column>
                <el-table-column width="260"
                        label="Name" prop="name_jp">
                </el-table-column>

                <el-table-column
                        label="Price">
                    <template slot-scope="props">
                        <div>{{props.row.r_price|currency_jpy}}</div>
                    </template>
                </el-table-column>
                <!--<el-table-column-->
                        <!--label="Catalogue">-->
    ...
    export default {
        ...
        methods:{
            loadCatalogueProducts(type){
                ...
                const url="/vendor/products/mine";
                console.log(_params)
