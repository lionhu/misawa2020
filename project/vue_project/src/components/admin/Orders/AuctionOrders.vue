  ...
  export default {
    ...
    methods: {
      ...
      SelectOrder(row, event, column){
        console.log("sigle auction order")
      ...
      load_orderlist(){
        ...
        this.$store.dispatch("orders/getAdminAuctionOrderList");
        this.tableData= this.$store.state.orders.AuctionOrders
        this.order_summaries= this.$store.state.orders.AuctionOrderSummary
