                    ...
                    <div class="table-responsive">
                        ...
                        <table id="example" class="display responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th class="center">订单支付</th>
                                <th class="center">儿孙提成</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($mypos as $mypo)
                                <tr id="rowID_{{$mypo->id}}">
                                    <th>
                                        ...
                                        <a href="{{route('customerAdmin_printPO',['poid'=>$mypo->id])}}">
                                    ...
                                    <th class="center">
                                        ...
                                        @if(Auth::user()->name !== $mypo->user->name)
                                           <span style="color: orangered">{{$mypo->user->name}}</span>
                                        @else
                                            {{$mypo->user->name}}
                                        @endif

                                        <i class="fa fa-long-arrow-right"></i>{{$mypo->vendor->name}}
                                    </th>
                            ...
                            <tfoot>
                            <tr>
                                <th colspan="8" style="text-align: center;background-color: dimgrey;color: white;">Good Work!</th>
                            </tr>
                            </tfoot>
                        </table>
                    </div>
                        ...
                        <div class="col_full clear-fix nobottommargin hidden-xs">
                            <table class="table cart">
                                ...
                                <tr>
                                    ...
                                    <th class="cart-product-quantity">采购价</th>
                                ...
                                <tr class="cart_item" v-for="poitem in items">
                                    ...
                                    <td class="cart-product-name">
                                        <a href="#">@{{poitem.item.name}}</a> <br>
                                        ID: @{{poitem.item.id}} <br>
                                        市场销售建议价: @{{poitem.item.o_price }} 
                                    </td>
                                    ...
                                    <td class="cart-product-subtotal">
                                        <span class="money">@{{poitem.total_b_price}}</span>
                                    </td>

                                    <td class="cart-product-subtotal">
                                        <span class="amount">@{{poitem.total_o_price }}</span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                                    ...
                                    <div class="hidden-xs">
                                        ...
                                        <table class="table cart">
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <td class="cart-product-name"><span class="amount">@{{po.cart_O_Price}}</span>
                                                </td>
                                            </tr>
                                            <tr class="cart_item">
                                                <td class="cart-product-name"><strong>总额</strong></td>
                                                <td class="cart-product-name"><strong><span
                                                                class="amount color lead">@{{po.cart_Dis_Price }} </span></strong>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
