                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="left" class="padding-copy textintenseStyle"
                                                ...
                                                <p style="margin-top:0;text-indent: 2em;">新しい注文が届いております。 お手数をおかけしますが、ご対応の程、よろしくお願いいたします！</p>
                        ...
                        <tr>
                            ...
                            <td style="padding: 40px 0 0 0;" class="no-padding">
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                    <tbody>
                                    <tr>
                                        <td align="left" class="padding-meta"
                                    ...
                                    <tr>
                                        <td align="left" class="padding-copy"
                                            style="padding: 0 25px 5px 0px; font-size: 1em; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #3F3D33;">SKU:
                                            {{$cartitem->product->product_code}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" class="padding-copy"
                                            style="padding: 0 25px 5px 0px; font-size: 1em; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #3F3D33;">
                                            {{$cartitem->product->name_jp}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" class="padding-copy"
                                            style="padding: 0 25px 5px 0px; font-size: 1em; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #3F3D33;">
                                            単価：<span class="money_jp">{{$cartitem->product->r_price}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" class="padding-copy articletextlightStyle"
                                            style="padding: 10px 25px 15px 0px; font-size: 16px; line-height: 24px; font-family: Helvetica, Arial, sans-serif; color: #3F3D33;">
                                            <p style="margin-top:0px">
                                                数量：{{$cartitem->qty}} <br>
                                                合計：<span class="money_jp">{{$cartitem->total_r_price}}</span>
                                            </p>
                                        </td>
                                    </tr>
                                    </tbody>
        ...
        <td bgcolor="#1ABC9C" align="center" class="section-padding" style="padding: 30px 15px 0px 15px;">
            <table border="0" cellpadding="0" cellspacing="0" width="500" style="padding: 0 0 20px 0;"
                ...
                <tr>
                    <td align="center" class="padding-copy" colspan="2"
                        style="padding: 0 0 10px 0px; font-size: 25px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #ffffff;">
                        合計金額：<span class="money_jp">{{$po->cart_R_Price}}</span>
                    </td>
                </tr>
                </tbody>
            </table>
