                        ...
                        <div class="shop product-3 grid-container clearfix">
                            ...
                            <div class="single-product">
                                ...
                                <form  enctype="multipart/form-data" role="form" method="POST"
                                      action="{{route('admin_Product_addNew')}}">
                                        ...
                                        <div class="col_half product-desc">
                                            ...
                                            <div class="col_full">
                                                ...
                                                <input type="text" id="manufactory" name="manufactory"  value="" class="sm-form-control">
                                            </div>
                                            <div class="col_full">
                                                <label for="product_code">Product Code:</label>
                                                <input type="text" id="product_code" name="product_code"  value="" class="sm-form-control">
                                            </div>
                                            ...
                                            <div class="col_full">
                                                ...
                                                <input type="text" id="name_jp" name="name_jp"  value="" class="sm-form-control">
                                            </div>

                                            <div class="col_half">
                                                <label for="unit">Unit:</label>
                                                <input type="text" id="unit" name="unit"  value="" class="sm-form-control">
                                            </div>

                                            <div class="col_half col_last clearfix">
                                                <label for="tablets">Tablets:</label>
                                                <input type="text" id="tablets" name="tablets"  value="" class="sm-form-control">
                                            </div>
                                            <div class="col_full clearfix">
                                                <div class="col_one_fourth">
                                                    <label for="o_price">O_Price:</label>
                                                    <input type="text" id="o_price" name="o_price"  value="" class="sm-form-control">
                                                </div>
                                                <div class="col_one_fourth">
                                                    <label for="b_price">B_Price:</label>
                                                    <input type="text" id="b_price"  value="" name="b_price" class="sm-form-control">
                                                </div>
                                                <div class="col_one_fourth">
                                                    <label for="r_price">R_Price:</label>
                                                    <input type="text" id="r_price" name="r_price"  value="" class="sm-form-control">
                                                </div>
