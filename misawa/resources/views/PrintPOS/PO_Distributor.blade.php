    ...
    <main>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            @foreach($cart_items as $item)
                <tr>
                    <td class="no">{{$item->product->id}}</td>
                    <td class="desc">
                    ...
                    <td class="unit ">
                        <span class="money_jp">{{$item->dis_price}}</span>
                         <br>
                        (..<span class="money_jp">{{$item->o_price}}</span>)
                    </td>
                    <td class="qty">{{$item->qty}}</td>
                    <td class="total money_jp">{{$item->total_dis_price}}</td>
                </tr>
            @endforeach
            ...
            <tr>
                ...
                <td><span class="money_jp">{{$po->cart_Dis_Price}}</span></td>
            </tr>
            </tfoot>
        </table>
