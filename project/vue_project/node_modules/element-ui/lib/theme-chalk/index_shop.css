...
.el-pagination .btn-next, .el-pagination .btn-prev {
	background: center center no-repeat #212529;
...
.el-menu--horizontal>.el-submenu.is-active .el-submenu__title {
	border-bottom: 2px solid #FCA505;
	color: #DADADA
}
...
.el-radio-button__orig-radio:checked+.el-radio-button__inner {
	...
	background-color: #FCA505;
	border-color: #FCA505;
	-webkit-box-shadow: -1px 0 0 0 #FCA505;
	box-shadow: -1px 0 0 0 #FCA505
}
...
.el-radio-button:focus:not(.is-focus):not(:active):not(.is-disabled) {
	-webkit-box-shadow: 0 0 2px 2px #FCA505;
	box-shadow: 0 0 2px 2px #FCA505
}
...
.el-table .sort-caret.ascending {
	border-bottom-color: #FB9404;
	top: 5px
}

.el-table .sort-caret.descending {
	border-top-color: #FB9404;
	bottom: 7px
}
...
.el-tabs__item:focus.is-active.is-focus:not(:active) {
	-webkit-box-shadow: 0 0 2px 2px #FCA505 inset;
	box-shadow: 0 0 2px 2px #FCA505 inset;
	border-radius: 3px
}
...
.el-color-predefine__color-selector.selected {
	-webkit-box-shadow: 0 0 3px 2px #FCA505;
	box-shadow: 0 0 3px 2px #FCA505
}
...
.el-button-group>.el-dropdown>.el-button {
	border-top-left-radius: 0;
	border-bottom-left-radius: 0;
	border-left-color: rgba(33, 37, 41, .5)
}

.el-button-group .el-button--primary:first-child {
	border-right-color: rgba(33, 37, 41, .5)
}
...
.el-link.is-underline:hover:after {
	...
	height: 0;
	bottom: 0;
	border-bottom: 1px solid #FCA505
}
...
.el-checkbox-button.is-checked .el-checkbox-button__inner {
	...
	background-color: #FCA505;
	border-color: #FCA505;
	-webkit-box-shadow: -1px 0 0 0 #a47213;
	box-shadow: -1px 0 0 0 #a47213
}

.el-checkbox-button.is-checked:first-child .el-checkbox-button__inner {
	border-left-color: #FCA505
}
...
.el-scrollbar__thumb {
	...
	cursor: pointer;
	border-radius: inherit;
	background-color: rgba(249, 147, 3, .3);
	-webkit-transition: .3s background-color;
	transition: .3s background-color
}

.el-scrollbar__thumb:hover {
	background-color: rgba(249, 147, 3, .5)
}
