...
import App from './components/Top_CustomerAdmin';
import store from "./store/customeradmin";
import router from "./router/customeradmin/index";
...
Vue.filter('deliveryURL', msaFilters.deliveryURL);
