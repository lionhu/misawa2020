                        ...
                        <div class="single-product">
                            ...
                            <form  enctype="multipart/form-data" role="form" method="POST"
                                ...
                                <div class="col_half product-desc">
                                    <div class="col_full nobottommargin">
                                        <div class="col_half bottommargin-sm">
                                            ...
                                            <input class="bt-switch" type="checkbox" checked data-on-text="Active" data-off-text="NO Active"
                                                   data-off-color="danger" data-on-color="success">
                                        </div>
                                    </div>
                                    <div class="col_full nobottommargin">
                                        <div class="white-section">
                                            <select class="col_half " name="vendor" id="vendor">
                                    ...
                                    <div class="col_full nobottommargin">
                                        <div class="white-section">
                                            <select class="col_half " name="catalogue" id="catalogue" v-model="product.catalogue" v-on:change="loadSubcatalogues">
                                                <option v-for="catalogue in catalogues" :value="catalogue.id" v-text="catalogue.name" ></option>
                                            </select>
                                            <label class="col_half col_last clearfix text-left">{{$product->catalogue->name}}</label>
                                        </div>
                                    </div>
                                    <div class="col_full nobottommargin">
                                        <div class="white-section">
                                            <select class="col_half clearfix" name="subcatalogue" id="subcatalogue" v-model="product.subcatalogue">
                                                <option v-for="subcatalogue in subcatalogues" :value="subcatalogue.id" v-text="subcatalogue.name" ></option>
                                            </select>
                                            <label class="col_half col_last text-left">{{$product->subcatalogue->name}}</label>
                                        </div>
                                    </div>
                                    <div class="col_full">
                                        <label for="manufactory">Manufactory:</label>
                                        <input type="text" id="manufactory" name="manufactory"  value="{{$product->manufactory}}" class="sm-form-control">
                                    </div>
                                    <div class="col_full">
                                        <label for="product_code">Product Code:</label>
                                        <input type="text" id="product_code" name="product_code"  value="{{$product->product_code}}" class="sm-form-control">
                                    </div>

                                    <div class="col_full">
                                        <label for="product_name">Product Name:</label>
                                        <input type="text" id="name" name="name"  value="{{$product->name}}" class="sm-form-control">
                                    </div>

                                    <div class="col_full">
                                        <label for="name_jp">Product Japanese Name:</label>
                                        <input type="text" id="name_jp" name="name_jp"  value="{{$product->name_jp}}" class="sm-form-control">
                                    </div>

                                    <div class="col_half">
                                        <label for="unit">Unit:</label>
                                        <input type="text" id="unit" name="unit"  value="{{$product->unit}}" class="sm-form-control">
                                    </div>

                                    <div class="col_half col_last clearfix">
                                        <label for="tablets">Tablets:</label>
                                        <input type="text" id="tablets" name="tablets"  value="{{$product->tablets}}" class="sm-form-control">
                                    </div>
                                    <div class="col_full clearfix">
                                        <div class="col_one_fourth">
                                            <label for="o_price">O_Price:</label>
                                            <input type="text" id="o_price" name="o_price"  value="{{$product->o_price}}" class="sm-form-control">
                                        </div>
                                        <div class="col_one_fourth">
                                            <label for="b_price">B_Price:</label>
                                            <input type="text" id="b_price"  value="{{$product->b_price}}" name="b_price" class="sm-form-control">
                                        </div>
                                        <div class="col_one_fourth">
                                            <label for="r_price">R_Price:</label>
                                            <input type="text" id="r_price" name="r_price"  value="{{$product->r_price}}" class="sm-form-control">
                                        </div>
                                ...
                                <div class="col_half col_last">
                                    ...
                                    <div class="col_full">
                                        ...
                                        @foreach($product->images as $image)
                                            <img src="{{asset($image->path_image)}}" style="width: 160px;height: 160px;">
                                        @endforeach
                                            <img src="{{asset($product->thumbImage)}}" style="width: 80px;height: 80px;">
                                    </div>
                                    <div class="col_full">
                                ...
                                <div class="col_full">
                                    ...
                                    <textarea  id="efficacy" name="efficacy" class="sm-form-control wysiwyg_text"  style="background-color: darkseagreen;">{{$product->efficacy}}</textarea>

                                </div>

                                <div class="col_full">
                                    <label for="description">Description:</label>
                                    <textarea  id="description" name="description" class="sm-form-control wysiwyg_text"  style="background-color: darkseagreen;">{{$product->description}}</textarea>

                                </div>

                                <div class="col_full">
                                    <label for="website">Notice:</label>
                                    <textarea  id="website" name="website" class="sm-form-control wysiwyg_text" style="background-color: darkseagreen;">{{$product->website}}</textarea>
...
@section("beforefunction_scripts")
    ...
    <script  type="text/javascript">
        ...
        {{--$("#catalogue").find('option[text="{{$product->catalogue->name}}"]').attr("selected",true);--}}
        {{--$("#catalogue").val({{$product->catalogue_id}});--}}

        {{--$("#catalogue").find('option[text="{{$product->catalogue->name}}"]').attr("lionhu",true);--}}
