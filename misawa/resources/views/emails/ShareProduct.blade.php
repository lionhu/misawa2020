                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="left" class="padding-copy textintenseStyle"
                                                ...
                                                <p style="margin-top:0;text-indent: 2em;">谢谢你选择MISAWA健康咨询的服务！希望能帮助到您和您的亲朋友好友！</p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="500" style="padding: 0 0 20px 0;"
                        ...
                        <tr>
                            <td valign="top" style="padding: 40px 0 0 0;" class="mobile-hide">
                                <img alt="{{asset($product->thumbImage)}}" width="105" border="0"
                                                                                                   style="display: block; font-family: Arial; color: #3F3D33; font-size: 14px; width: 105px;"
                                                                                                   src="{{asset($product->thumbImage)}}">
                            </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="500" style="padding: 0 0 20px 0;"
                ...
                <tr>
                    <td align="center" class="padding-copy" colspan="2"
                        style="padding: 0 0 10px 0px; font-size: 15px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #ffffff;">
                        希望能帮助到您和您的亲朋友好友！
                    </td>
                </tr>
                </tbody>
