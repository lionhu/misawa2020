                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    <span style="color: #ffffff; text-decoration: none;">KPZH International Healthcare Service</span>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <td bgcolor="#3F3D33" width="50%" align="right" class="mobile-hide">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td align="right"
                                                    style="padding: 0 0 5px 0; font-size: 12px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none;">
                                                    <a href="http://shop.misawa-pharmacy.com" style="color: #ffffff;"
                                                       target="_new"><span>View on web</span></a></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </td>
