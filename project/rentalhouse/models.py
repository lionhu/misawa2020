...
class RentalHistory(models.Model):
    slug = models.SlugField(null=True,blank=True,default=now_slug)
    product = models.ForeignKey(RentalProduct,on_delete=models.CASCADE, blank=False, null=False, related_name="rentalproducts")
    user = models.ForeignKey(User,on_delete=models.CASCADE,blank=False,null=False,related_name="myrentals")
