                    ...
                    <div class="card color">
                        ...
                        <table class="table">
                            ...
                            <tr v-for="His in Last3MonthSummary">
                                <td>{{His.PO_Month}}</td>
                                <td>{{His.po_count}}</td>
                                <td>{{His.total_B_price | currency_rmb}}</td>
                                <td class="hidden-xs">{{His.total_R_price-His.total_paid_vendor | currency_jpy}}</td>
                                <td>{{His.total_B_price-parseInt(His.total_R_price*currencyRate/100) | currency_rmb}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
